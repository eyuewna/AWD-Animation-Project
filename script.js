...
album.forEach( element => {
  element.addEventListener('click', () => {
    ...
    function randomImage() {
      const images = [
        './platter_images/image1.gif',
        './platter_images/image2.gif',
        './platter_images/image3.gif',
        './platter_images/image4.gif',
        './platter_images/image5.gif',
        './platter_images/image6.gif',
        './platter_images/image7.gif',
        './platter_images/image8.gif',
      ];
